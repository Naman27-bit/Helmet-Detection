...
Original file is located at
    https://colab.research.google.com/drive/1FVRVBQTMJWgLSnKarGVYuT3Nw35ST2Ul
"""
...
# CONFIG
# =========================
# The original path was a Windows-style local path and not accessible in Colab.
# Replacing it with a pre-trained YOLOv8n model for demonstration. If you have a
# custom model, please upload it to Colab and update this path accordingly.
